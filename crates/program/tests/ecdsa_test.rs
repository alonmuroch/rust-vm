...
mod tests {
    ...
    fn test_verify_signature_hash_with_real_data() {
        ...
        println!("Public key (compressed): {} bytes", pubkey.len());
    ...
    fn test_verify_signature_hash_with_second_transaction_data() {
        ...
        let pubkey = [
            0x02, 0x88, 0xe2, 0xdd, 0xeb, 0x04, 0x65, 0x7d,
            0xbd, 0x0e, 0xda, 0xdf, 0x9c, 0x1f, 0x98, 0xda,
            0x3b, 0x38, 0x95, 0xfa, 0xa1, 0xf0, 0x05, 0x27,
            0x93, 0x4d, 0xd3, 0x5d, 0x17, 0x54, 0x2f, 0xfe,
            0x9b
        ];
